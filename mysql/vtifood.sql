DROP DATABASE IF EXISTS `vti_food`;

CREATE DATABASE IF NOT EXISTS `vti_food`;

use `vti_food`;

CREATE TABLE categories(
    id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(100) NOT NULL DEFAULT '' COMMENT 'Tên danh mục, vd: đồ uống'
...
-- Bảng chứa sản phẩm(Product) : 'Chân gà ...'
...
*/
INSERT INTO `users` (`id`,`firstname`,`lastname`,`phone_number`,`username`,`password`,`date_of_birth`,`email`,`address`,`created_at`,`updated_at`,`role_id`)
VALUES (1,'Trinh','Nguyen Van ','0899633453','admin','$2a$10$wPhIIXNXdyPMbnmPRjHwlOER6ZhXUcsRuj6vvM2xaVXaCjC9RuMfi','2000-04-03','nvantrinh0403@gmail.com','Quang Binh','2024-07-16 11:13:51',NULL,1),
(2,'Lai','Do','0987656341','laido','$2a$10$wPhIIXNXdyPMbnmPRjHwlOER6ZhXUcsRuj6vvM2xaVXaCjC9RuMfi','2000-09-16','laido@gmail.com','Quang Binh','2024-07-16 11:14:49','2024-07-16 14:42:38',2),
(3,'Hoang','Nguyen','0987656344','nguyenhoang','$2a$10$wPhIIXNXdyPMbnmPRjHwlOER6ZhXUcsRuj6vvM2xaVXaCjC9RuMfi','2001-10-09','hoang@gmail.com','Quang Binh','2024-07-16 12:04:05','2024-07-16 14:43:06',2);
